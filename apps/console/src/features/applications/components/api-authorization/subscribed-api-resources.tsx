...
interface SubscribedAPIResourcesProps extends
    ...
    templateId: string;
    /**
     * Total of API Resources available
     */
    allAPIResourcesTotal: number;
    /**
...
export const SubscribedAPIResources: FunctionComponent<SubscribedAPIResourcesProps> = (
     ...
     */
    const showPlaceHolders: boolean = allAPIResourcesTotal === 0 ||
    ...
    const getPlaceholders = (): ReactElement => {
        ...
        } else if (allAPIResourcesTotal === 0) {
            return (
                <EmptyPlaceholder
